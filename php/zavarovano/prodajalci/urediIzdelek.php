		...
		<div class="urejanje-izdelka">
			<div>
				...
				<form method="post" action="" enctype='multipart/form-data'>
					...
					<input type='submit' class="btn btn-outline-secondary" value="Dodaj slike" name='but_upload'>
				</form>
				...
				<form action="urediIzdelekIzvedba.php" method="post">
					...
					?>
					<input type="submit" class="btn btn-dark" name="shrani" value="Shrani spremembe">
				</form>
			</div>
		</div>
	</div>
