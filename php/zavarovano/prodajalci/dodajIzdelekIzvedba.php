<?php
	...
	if(!isset($_POST['base64slika2']) && !isset($_POST['base64slika3'])){
	...
	$trenutniIzdelek = mysqli_query($dbConnection, "SELECT * FROM artikli ORDER BY idArtikla DESC LIMIT 1");
	$id=$trenutniIzdelek['idArtikla'];
