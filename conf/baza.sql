...
(11,'Xiaomi Roborock S6 Pure robotski sesalnik + darilo','Xiaomi Roborock S6 Pure robotski sesalnik se ponaša z natančnim laserskim navigacijskim sistemom, modernim dizajnom bele barve, izjemno sesalno močjo, samodejnim polnjenjem in tihim delovanjem.',399.99,1,224,52,'0cGTq8ZRHam749BgWPydWhEIKCtFL'),
(12,'Rulyt Calter Fiesta viseča mreža, rdeča','Kakovostna viseča mreža je izdelana iz trpežnih materialov in je odlična izbira za počitek in sprostitev po napornem dnevu. Postavite jo lahko na vrtu, terasi ali v naravi, primerna pa je tako za odrasle, kot za otroke.',26.60,1,23,7,'0cGTq8ZRHam749BgWPydWhEIKCtFL'),
(13,'Sony zvočnik GTKXB60B, črn','Sony zvočnik z vgrajenimi lučmi, akumulatorsko baterijo ter Aux in USB vhodom zagotavlja do 14 ur predvajanja glasbe. Ponaša se s funkcijo Extra Bass, ki izboljša nizke frekvence v skladbi in ustvari ritem, zaradi katerega se vsi odpravijo na plesišče.',199.99,1,42,9,'0cGTq8ZRHam749BgWPydWhEIKCtFL'),
(14,'Asus VA27EHE monitor, IPS, 68,6cm, FHD (90LM0550-B01170)','Monitor Asus VA27EHE odlikuje Full HD (1920×1080) ločljivost, diagonala s 68,6 cm (27"), frekvenca osveževanja 75 Hz in tehnologija Adaptive-Sync/FreeSync. ',149.85,1,42,10,'0cGTq8ZRHam749BgWPydWhEIKCtFL'),
(15,'Western Digital My Cloud Home 14TB NAS (WDBVXC0040HWT-EESN)','Naprava za shranjevanje v oblaku My Cloud Home se neposredno priključi na vaš domači usmerjevalnik Wi-Fi, tako da lahko enostavno shranite, organizirate in nadzorujete vse vaše digitalne vsebine na enem mestu in dostopate do njih brezžično od koder koli.',176.49,1,0,0,'0cGTq8ZRHam749BgWPydWhEIKCtFL');
UNLOCK TABLES;
