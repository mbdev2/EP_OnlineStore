...
INSERT INTO `artikli` VALUES 	(1,'Polar senzor srčnega utripa H10 BLK','Najnatančnejši senzor srčnega utripa znamke Polar, sedaj z izboljšanimi elektrodami H10. Združljiv je z vodilnimi aplikacijami za telesno pripravljenost in napravami Bluetooth. Frekvenca prenosa je 5 kHz, zaradi česar se srčni utrip lahko spremlja tudi pod vodo. Vgrajen ima pomnilnik za shranjevanje podatkov o srčnem utripu. Zelo je udoben, saj je narejen iz mehkega blaga, drsenje pa preprečujejo silikonski čepki in zaponke.',79.99,1,19,4),
